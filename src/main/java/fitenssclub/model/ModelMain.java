...
public class ModelMain {
    ...
    private static void createDatabase(String filesPath) {
        ...
        Activity newActivity = new Activity("Crossfit", LocalDateTime.parse("2016-12-27T08:15:05", DateTimeFormatter.ISO_LOCAL_DATE_TIME), bartek, manager, new Room("p110", 30));
